...
Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung der Webseite bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie die Verarbeitung dieser Daten durch Google verhindern, indem sie das unter dem folgenden Link verfügbare Browser-Plugin herunterladen und installieren: http://tools.google.com/dlpage/gaoptout?hl=de. Alternativ zum Browser-Add-On, insbesondere bei Browsern auf mobilen Endgeräten, können Sie die Erfassung durch Google Analytics zudem wie folgt verhindern:

1. Zuerst klicken Sie <a on="tap:ncCookieConsent.prompt">diesen Link</a>, um den Dialog für die Cookiegenehmigung anzuzeigen (hier können Sie jederzeit auch "Akzeptieren")
2. Zur entgültigen Verweigerung klicken Sie danach auf <a on="tap:ncCookieConsent.reject">diesen Link</a>, um Ihre Zustimmung zu verweigrrn. 
